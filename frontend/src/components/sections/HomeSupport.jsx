...
const supportCopy = {
  ...
  description: "Everything you need to know about Acecore's products, installation, pricing, and support.",
};
    ...
    <section className="home-support" aria-labelledby="home-support-title">
      <div className="home-shell">
        <Reveal className="home-section-header">
          ...
          <p className="home-section-header__description">{supportCopy.description}</p>
        </Reveal>

        <Reveal className="home-support__faq" y={24}>
          <Accordion items={homeFaqs} className="home-support__accordion" />
        </Reveal>
      </div>
    </section>
  );
